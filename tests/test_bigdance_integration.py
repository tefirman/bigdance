...
def mock_standings():
    ...
    teams_data = {
        'ACC': [
            ('Duke', 1800), ('North Carolina', 1780), ('Virginia', 1760),
            ('Miami FL', 1740), ('Clemson', 1720), ('Pittsburgh', 1700),
            ('Wake Forest', 1680), ('NC State', 1660)
        ],
        'Big 12': [
            ('Kansas', 1795), ('Houston', 1775), ('Texas', 1755),
            ('Baylor', 1735), ('Iowa State', 1715), ('TCU', 1695),
            ('Oklahoma', 1675), ('Kansas State', 1655)
        ],
        'Big East': [
            ('UConn', 1790), ('Marquette', 1770), ('Creighton', 1750),
            ('Villanova', 1730), ('Providence', 1710), ('Butler', 1690),
            ('St. John\'s', 1670), ('Seton Hall', 1650)
        ],
        'Big Ten': [
            ('Purdue', 1785), ('Illinois', 1765), ('Michigan State', 1745),
            ('Wisconsin', 1725), ('Indiana', 1705), ('Ohio State', 1685),
            ('Michigan', 1665), ('Iowa', 1645)
        ],
        'Pac-12': [
            ('Arizona', 1780), ('UCLA', 1760), ('USC', 1740),
            ('Utah', 1720), ('Colorado', 1700), ('Oregon', 1680),
            ('Washington', 1660), ('Stanford', 1640)
        ],
        'SEC': [
            ('Tennessee', 1775), ('Kentucky', 1755), ('Alabama', 1735),
            ('Auburn', 1715), ('Florida', 1695), ('Arkansas', 1675),
            ('Texas A&M', 1655), ('South Carolina', 1635)
        ],
        'American': [
            ('Memphis', 1720), ('FAU', 1700), ('SMU', 1680),
            ('South Florida', 1660), ('UAB', 1640), ('Charlotte', 1620)
        ],
        'Mountain West': [
            ('San Diego State', 1710), ('Utah State', 1690), ('Nevada', 1670),
            ('Boise State', 1650), ('New Mexico', 1630), ('Colorado State', 1610)
        ],
        'WCC': [
            ('Gonzaga', 1750), ('Saint Mary\'s', 1730), ('San Francisco', 1650),
            ('Santa Clara', 1630), ('Loyola Marymount', 1610)
        ],
        'Atlantic 10': [
            ('Dayton', 1700), ('VCU', 1680), ('Richmond', 1640),
            ('Saint Louis', 1620), ('Davidson', 1600)
        ]
    }
